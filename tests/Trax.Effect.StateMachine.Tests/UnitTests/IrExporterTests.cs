...
public class IrExporterTests
{
    ...
    public void Export_matches_the_committed_ir_golden()
    {
        ...
        const string golden =
            """{"committedStates":[],"context":{"Locked":{"fields":[]},"Unlocked":{"fields":[{"constraints":[{"field":"paidWith","rule":"nonEmpty","source":"context"}],"name":"paidWith","nullable":false,"type":"string"}]}},"id":"turnstile","initialState":"Locked","inputs":{"Coin":{"fields":[{"constraints":[],"name":"coin","nullable":false,"type":"string"}]}},"states":["Locked","Unlocked"],"transitions":[{"from":"Locked","guard":{"field":"coin","rule":"oneOf","source":"input","values":["quarter","dollar"]},"guardMessage":"Only a quarter or a dollar is accepted.","reduce":{"reduce":"set","steps":[{"field":"paidWith","value":{"input":"coin"}}]},"to":"Unlocked","trigger":"Coin"},{"from":"Unlocked","reduce":{"reduce":"clear"},"to":"Locked","trigger":"Push"}],"triggers":["Coin","Push"],"version":1}""";
